...
| ~                  | setStorageSync                                         | 将数据存储在本地缓存中指定的 key 中                                                                                                     |
...
| 获取位置           | getLocation                                            | 获取当前的地理位置、速度。当用户离开智能小程序后，此接口无法调用                                                                        |
...
| ~                  | showLoading                                            | 显示 loading 提示框, 需主动调用 hideLoading 才能关闭提示框                                                                              |
| ~                  | hideToast                                              | 隐藏消息提示框                                                                                                                          |
...
| 导航               | navigateTo                                             | 保留当前页面，跳转到应用内的某个页面，使用 swan.navigateBack 可以返回到原页面                                                           |
